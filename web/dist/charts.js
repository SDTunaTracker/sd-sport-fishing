var __charts = (() => {
  ...
  function LayerPanel({
    ...
    return /* @__PURE__ */ React.createElement("div", { className: "layer-panel" }, /* @__PURE__ */ React.createElement("div", { className: "layer-group" }, /* @__PURE__ */ React.createElement("div", { className: "layer-group-label" }, "Base"), /* @__PURE__ */ React.createElement("div", { className: "layer-group-row" }, bases.map(function(b) {
      ...
      onBoats(!showBoats);
    } }, /* @__PURE__ */ React.createElement("span", { className: "layer-btn-icon" }, "\u{1F6A2}"), "Boats", /* @__PURE__ */ React.createElement("span", { className: "layer-live-badge" }, "LIVE")))));
  }
    ...
    React.useEffect(function() {
      ...
      mapInstance.current.on("click", function(e) {
        ...
        L.popup({ className: "tt-popup" }).setLatLng(e.latlng).setContent(
          '<div class="map-popup"><div class="popup-coords">' + lat.toFixed(4) + "\xB0N,&nbsp;" + Math.abs(lng).toFixed(4) + '\xB0W</div><button class="popup-save-waypoint" onclick="window.ttOpenWaypointModal(' + lat + "," + lng + ')">+ Save as waypoint</button></div>'
